...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{route('app.admin.penduduk.update', [$penduduk->nik])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="select2 form-control @error('pekerjaan') is-invalid @enderror"
                                            ...
                                            @foreach ($pekerjaan as $item)
                                                <option value="{{ $item->id }}" {{ $item->id==$penduduk->id_pekerjaan?'selected':'' }}>{{ $item->keterangan }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('id_pekerjaan')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select
                                            class="select2 form-control @error('kewarganegaraan') is-invalid @enderror"
                                    ...
                                    <div class="col-lg-8">
                                        <select
                                            ...
                                            @foreach ($pendidikan as $item)
                                                <option value="{{ $item->id }}" {{ !empty($pendidikan->id_pendidikan)?($item->id==$penduduk->id_pendidikan?'selected':'' ):''}}>{{ $item->keterangan }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('id_pendidikan')
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">Agama<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8">
                                        <select
                                            class="select2 regency form-control @error('agama') is-invalid @enderror"
                                            ...
                                            <option value="khatolik" {{ $penduduk->agama == 'KHATOLIK' ? 'selected' : '' }}>KHATOLIK</option>
                                            ...
                                            <option value="kepercayaan" {{ $penduduk->agama == 'KEPERCAYAAN' ? 'selected' : '' }}>KEPERCAYAAN</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('regency_id')
                                                {{ $message }}
                                    ...
                                    <div class="col-lg-8">
                                        <select
                                            ...
                                            @foreach ($statusPerkawinan as $item)
                                                <option value="{{ $item->id }}" {{ $item->id==$penduduk->id_status_perkawinan?'selected':'' }}>{{ $item->keterangan }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select required name="id_sdhk" id="id_sdhk"
                                            ...
                                            <option value="{{ $item->id }}" {{ $item->id==$penduduk->id_sdhk?'selected':'' }}>{{ $item->keterangan }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('id_sdhk')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select required name="rt_id" id="rt_id"
                                            ...
                                            @foreach ($rt as $item)
                                                <option value="{{ $item->id }}" {{ $penduduk->rt_id == $item->id ? 'selected' : '' }}>RT : {{ $item->nomor }} | RW :
                                                    {{ $item->rw }} | {{ $item->dusun }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-8">
                                        <select required name="province_id" id="province_id"
                                            ...
                                            @foreach ($province as $item)
                                                <option value="{{ $item->id }}" {{ $penduduk->province_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('province_id')
